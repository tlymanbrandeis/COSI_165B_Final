...
class Generator(nn.Module):
    ''' C-RNN-GAN generator
    '''
    def __init__(self, num_feats = 25, hidden_units=256, drop_prob=0.5, use_cuda=False):
...
class Discriminator(nn.Module):
    ...
    def forward(self, seq, state):
        ...
        # seq: (batch_size, seq_len, num_feats)
        drop_in = self.dropout(seq) # input with dropout
